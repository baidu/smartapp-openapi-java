 ...
 **/
public class SmartAppCategoryUpdateDemo {
    public static void main(String[] args) {
        SmartAppThirdPartyClient smartAppThirdPartyClient = new SmartAppThirdPartyClient();
        // 开发者在此设置请求参数，实际参数请参考文档说明填写
        // 如果开发者不想传非必需参数，可以将设置该参数的行注释
        String accessToken = "xxx";
        String categories = "xxx";
        try {
            Examine examine = smartAppThirdPartyClient.getAppService().categoryUpdate(accessToken, categories);
