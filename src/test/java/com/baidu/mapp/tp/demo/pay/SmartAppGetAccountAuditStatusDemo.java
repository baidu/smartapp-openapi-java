 ...
 **/
public class SmartAppGetAccountAuditStatusDemo {
    public static void main(String[] args) {
        ...
        try {
            PaymentAccount accountAuditStatus = smartAppThirdPartyClient.getPaymentService().getAccountAuditStatus(accessToken);
