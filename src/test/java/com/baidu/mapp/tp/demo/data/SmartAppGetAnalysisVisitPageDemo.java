 ...
 **/
public class SmartAppGetAnalysisVisitPageDemo {
    public static void main(String[] args) {
        ...
        String endDate = "xxx";
        try {
            MTJDataStatisticsResult analysisVisitPage = smartAppThirdPartyClient.getDataStatisticsService()
                    .getAnalysisVisitPage(accessToken, startIndex, startDate, endDate);
