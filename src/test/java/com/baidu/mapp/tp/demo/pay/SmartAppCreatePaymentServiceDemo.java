 ...
 **/
public class SmartAppCreatePaymentServiceDemo {
    public static void main(String[] args) {
        ...
        try {
            smartAppThirdPartyClient.getPaymentService().createPaymentService(accessToken, appName, servicePhone, bankAccount,
