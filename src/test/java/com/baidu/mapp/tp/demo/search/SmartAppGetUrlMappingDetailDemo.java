 ...
 **/
public class SmartAppGetUrlMappingDetailDemo {
    public static void main(String[] args) {
        ...
        Long ruleId = 0L;
        try {
            List<UrlMapping> urlMappingDetail = smartAppThirdPartyClient.getNaturalSearchService()
                    .getUrlMappingDetail(accessToken, ruleId);
