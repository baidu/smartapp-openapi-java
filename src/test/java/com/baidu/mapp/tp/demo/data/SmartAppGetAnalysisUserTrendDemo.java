 ...
 **/
public class SmartAppGetAnalysisUserTrendDemo {
    public static void main(String[] args) {
        ...
        String gran = "xxx";
        try {
            MTJDataStatisticsResult analysisUserTrend = smartAppThirdPartyClient.getDataStatisticsService()
                    .getAnalysisUserTrend(accessToken, startIndex, startDate, endDate, gran);
