 ...
 **/
public class SmartAppTemplateListDemo {
    public static void main(String[] args) {
        ...
        Integer count = 0;
        try {
            TemplateExistsList templateExistsList = smartAppThirdPartyClient.getTemplateMessageService().templateList(accessToken,
                    offset, count);
