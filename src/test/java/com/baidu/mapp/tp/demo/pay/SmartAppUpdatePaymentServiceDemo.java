 ...
 **/
public class SmartAppUpdatePaymentServiceDemo {
    public static void main(String[] args) {
        ...
        try {
            smartAppThirdPartyClient.getPaymentService().updatePaymentService(accessToken, appName, servicePhone, poolCashPledge);
