 ...
 **/
public class SmartAppGetAnalysisRegionDemo {
    public static void main(String[] args) {
        ...
        String endDate = "xxx";
        try {
            MTJDataStatisticsResult analysisRegion = smartAppThirdPartyClient.getDataStatisticsService()
                    .getAnalysisRegion(accessToken, startIndex, startDate, endDate);
