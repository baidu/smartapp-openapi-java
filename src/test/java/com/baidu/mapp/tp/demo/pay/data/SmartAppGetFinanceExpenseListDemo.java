 ...
 **/
public class SmartAppGetFinanceExpenseListDemo {
    public static void main(String[] args) {
        ...
        String endTime = "xxx";
        try {
            FinanceExpenseListClient financeExpenseList = smartAppThirdPartyClient.getPaymentService()
                    .getFinanceExpenseList(accessToken, currentPage, pageSize, startTime, endTime);
