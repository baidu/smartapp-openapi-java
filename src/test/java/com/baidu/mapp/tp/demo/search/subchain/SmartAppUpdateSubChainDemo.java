 ...
 **/
public class SmartAppUpdateSubChainDemo {
    public static void main(String[] args) {
        ...
        try {
            Boolean updateSubChain = smartAppThirdPartyClient.getNaturalSearchService()
                    .updateSubChain(accessToken, subChainId, chainName, chainDesc, chainPath, telephone);
