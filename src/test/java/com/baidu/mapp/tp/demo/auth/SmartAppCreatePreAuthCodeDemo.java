 ...
 **/
public class SmartAppCreatePreAuthCodeDemo {
    public static void main(String[] args) {
        ...
        try {
            PreAuthCode preAuthCode = smartAppThirdPartyClient.getAuthorizationProcessService().createPreAuthCode(accessToken);
