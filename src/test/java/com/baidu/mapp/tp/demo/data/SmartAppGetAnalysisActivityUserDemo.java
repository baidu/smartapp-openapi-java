 ...
 **/
public class SmartAppGetAnalysisActivityUserDemo {
    public static void main(String[] args) {
        ...
        String endDate = "xxx";
        try {
            MTJDataStatisticsResult analysisActivityUser = smartAppThirdPartyClient.getDataStatisticsService()
                    .getAnalysisActivityUser(accessToken, startIndex, startDate, endDate);
