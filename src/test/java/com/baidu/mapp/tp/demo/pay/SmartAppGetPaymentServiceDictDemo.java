 ...
 **/
public class SmartAppGetPaymentServiceDictDemo {
    public static void main(String[] args) {
        ...
        try {
            PaymentServiceDictClient paymentServiceDict = smartAppThirdPartyClient.getPaymentService()
                    .getPaymentServiceDict(accessToken);
