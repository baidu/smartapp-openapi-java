 ...
 **/
public class SmartAppAddToTemplateDemo {
    public static void main(String[] args) {
        ...
        String userDesc = "xxx";
        try {
            AddToTemplate addToTemplate = smartAppThirdPartyClient.getTemplateManagementService()
                    .addToTemplate(accessToken, draftId, userDesc);
