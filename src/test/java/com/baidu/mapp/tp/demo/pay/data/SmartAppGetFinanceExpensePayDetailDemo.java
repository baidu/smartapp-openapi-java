 ...
 **/
public class SmartAppGetFinanceExpensePayDetailDemo {
    public static void main(String[] args) {
        ...
        Long taskId = 0L;
        try {
            FinanceExpensePayDetailListClient financeExpensePayDetail = smartAppThirdPartyClient.getPaymentService()
                    .getFinanceExpensePayDetail(accessToken, taskId);
