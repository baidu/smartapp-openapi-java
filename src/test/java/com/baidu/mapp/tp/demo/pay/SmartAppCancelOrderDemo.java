...
public class SmartAppCancelOrderDemo {
    public static void main(String[] args) {
        ...
        try {
            ApplyOrderRefundResponseClient applyOrderRefundResponseClient = smartAppThirdPartyClient
                    .getPaymentService().applyOrderRefund(accessToken, pmAppKey, applyOrderRefundClient);
