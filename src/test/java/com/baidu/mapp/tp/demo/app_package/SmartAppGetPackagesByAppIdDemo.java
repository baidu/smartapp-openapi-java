 ...
 **/
public class SmartAppGetPackagesByAppIdDemo {
    public static void main(String[] args) {
        ...
        try {
            List<PackageResp> packagesByAppId = smartAppThirdPartyClient.getPackageManagementService()
                    .getPackagesByAppId(accessToken);
