 ...
 **/
public class SmartAppPaymentCertificationDemo {
    public static void main(String[] args) {
        ...
        try {
            PaymentCertification paymentCertification = smartAppThirdPartyClient.getAuthenticityCertificationService()
                    .paymentCertification(accessToken);
