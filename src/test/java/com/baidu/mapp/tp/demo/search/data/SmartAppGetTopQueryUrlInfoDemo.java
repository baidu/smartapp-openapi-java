 ...
 **/
public class SmartAppGetTopQueryUrlInfoDemo {
    public static void main(String[] args) {
        ...
        Integer pageSize = 0;
        try {
            TopQueryInfo topQueryUrlInfo = smartAppThirdPartyClient.getNaturalSearchService()
                    .getTopQueryUrlInfo(accessToken, timeSpan, pageNum, pageSize);
