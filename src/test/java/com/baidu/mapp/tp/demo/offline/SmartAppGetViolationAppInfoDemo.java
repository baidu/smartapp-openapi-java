 ...
 **/
public class SmartAppGetViolationAppInfoDemo {
    public static void main(String[] args) {
        ...
        try {
            ViolationAppDetails violationAppInfo = smartAppThirdPartyClient.getOfflineViolationService()
                    .getViolationAppInfo(accessToken);
