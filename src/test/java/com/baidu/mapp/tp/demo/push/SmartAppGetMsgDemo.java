package com.baidu.mapp.tp.demo.push;
 ...
 **/
public class SmartAppGetMsgDemo {
    public static void main(String[] args) {
        ...
        String idList = "xxx";
        try {
            SmartAppPageB<PushMsg> msg = smartAppThirdPartyClient.getPushMsgService()
                    .getMsg(accessToken, start, end, pushType, offset, count, idList);
