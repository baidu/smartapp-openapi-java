 ...
 **/
public class SmartAppGetAnalysisSourceInfoDemo {
    public static void main(String[] args) {
        ...
        String endDate = "xxx";
        try {
            MTJDataStatisticsResult analysisSourceInfo = smartAppThirdPartyClient.getDataStatisticsService()
                    .getAnalysisSourceInfo(accessToken, startIndex, startDate, endDate);
