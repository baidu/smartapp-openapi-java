 ...
 **/
public class SmartAppGetTradeIndustryListDemo {
    public static void main(String[] args) {
        ...
        try {
            List<TradeIndustry> tradeIndustryList = smartAppThirdPartyClient.getPaymentService()
                    .getTradeIndustryList(accessToken);
