 ...
 **/
public class SmartAppModifyWebViewDomainDemo {
    public static void main(String[] args) {
        ...
        String webViewDomain = "xxx";
        try {
            List<String> strings = smartAppThirdPartyClient.getThirdPartyDomainService()
                    .modifyWebViewDomain(accessToken, action, webViewDomain);
