 ...
 **/
public class SmartAppGetFinanceBalanceDemo {
    public static void main(String[] args) {
        ...
        String endTime = "xxx";
        try {
            FinanceBalanceListClient financeBalance = smartAppThirdPartyClient.getPaymentService().getFinanceBalance(accessToken,
