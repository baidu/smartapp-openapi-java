 ...
 **/
public class SmartAppUploadRobotsForTemplateDemo {
    public static void main(String[] args) {
        ...
        try {
            String robotsForTemplate = smartAppThirdPartyClient.getNaturalSearchService()
                    .uploadRobotsForTemplate(accessToken, templateId, robots);
