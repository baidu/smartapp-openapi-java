 ...
 **/
public class SmartAppSaveUrlMappingDemo {
    public static void main(String[] args) {
        ...
        Byte createMethod = 0;
        try {
            Boolean saveUrlMapping = smartAppThirdPartyClient.getNaturalSearchService()
                    .saveUrlMapping(accessToken, content, createMethod);
