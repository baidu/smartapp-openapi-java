 ...
 **/
public class SmartAppGetPaymentServiceAuditStatusDemo {
    public static void main(String[] args) {
        ...
        try {
            PaymentServiceVO paymentServiceAuditStatus = smartAppThirdPartyClient.getPaymentService()
                    .getPaymentServiceAuditStatus(accessToken);
