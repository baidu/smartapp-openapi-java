 ...
 **/
public class SmartAppTemplateAddDemo {
    public static void main(String[] args) {
        ...
        Integer id = 0;
        String keywordIdList = "xxx";
        try {
            AddMessageTemplate addMessageTemplate = smartAppThirdPartyClient.getTemplateMessageService().templateAdd(accessToken,
                    id, keywordIdList);
