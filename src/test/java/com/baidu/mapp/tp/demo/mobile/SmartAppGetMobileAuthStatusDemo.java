 ...
 **/
public class SmartAppGetMobileAuthStatusDemo {
    public static void main(String[] args) {
        ...
        try {
            MobileAuthStatus mobileAuthStatus = smartAppThirdPartyClient.getMobileService().getMobileAuthStatus(accessToken);
